        ...
        <Stack alignItems={"center"} spacing={4}>
          ...
          <Stack sx={{ width: 'max-content' }} direction="column" alignItems="center" spacing={3}>
            ...
            {selected === 3 ?
              ...
              :
              (<IconButton onClick={() => { setSelected(3); navigate(getPath(3)) }} sx={{ width: 'max-content', color: theme.palette.mode === "light" ? "#000" : theme.palette.text.primary }}><Gear /></IconButton>)
            }
          </Stack>
            ...
            <Stack spacing={1} px={1}>
              {
                Profile_Menu.map((el, idx) => {
                  return <MenuItem onClick={() => {
                    ...
                    <Stack onClick={() => navigate(getMenuPath(idx))} direction="row" sx={{ width: 100 }} alignItems={"center"} justifyContent="space-between">
                      <span>{el.title}</span>
                      {el.icon}
                    </Stack>
                  </MenuItem>
